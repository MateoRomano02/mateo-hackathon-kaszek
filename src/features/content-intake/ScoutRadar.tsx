      ...
      <div className="card" style={{ marginBottom: 24 }}>
        {!isScanning ? (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <h3 style={{ fontSize: 16, fontFamily: 'var(--font-serif)', marginBottom: 4 }}>Autonomous Scout Radar</h3>
            <p style={{ fontSize: 13, color: 'var(--text2)', marginBottom: 16, maxWidth: 400, margin: '0 auto 16px' }}>
              Scans Hacker News and Reddit based on your stack. Filters by relevance. Processes with the Truth Pipeline.
            </p>
            <button className="btn btn-primary btn-lg" onClick={scanTrends}>
              Scan Trends for My Stack
            </button>
          </div>
        ) : (
          <>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                <span className="card-label" style={{ margin: 0 }}>Scanning...</span>
            ...
            <div style={{
              ...
              {isScanning && (
                <div style={{ display: 'flex', gap: 8, color: '#c4b5fd' }}>
                  <span style={{ color: '#6b7280' }}>{new Date().toLocaleTimeString('en-US')}</span>
      ...
      {radarItems.length > 0 && (
        <div>
          <div className="card-label" style={{ marginBottom: 12 }}>
            Radar Findings ({radarItems.length})
          </div>
